...
const iconMap = {
  github: {
    icon: <GitFork size={22} strokeWidth={1.5} />,
    color: "#e0e0e0",
  ...
  code: {
    ...
    color: "#f89f1b",
    bg: "rgba(248,159,27,0.12)",
    desc: "DSA & problem solving",
  },
  gfg: {
    icon: <BookOpen size={22} strokeWidth={1.5} />,
    color: "#2f8d46",
    bg: "rgba(47,141,70,0.12)",
    desc: "Articles & tutorials",
  },
  medium: {
    icon: <ExternalLink size={22} strokeWidth={1.5} />,
    color: "#ff6347",
    ...
    <PageTransition>
      <div className="inner-page">
        ...
        <div className="inner-card" style={{ marginBottom: 12 }}>
          ...
          >
            Find me across the web — from open-source contributions and
            professional networking to writing, DSA practice, and technical
            articles.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <ArrowUpRight
                  size={14}
                  strokeWidth={1.8}
                  style={{ color: "var(--text-dim)", marginTop: "auto" }}
                />
              </motion.a>
            );
          })}
