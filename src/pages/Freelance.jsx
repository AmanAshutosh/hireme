...
const fadeUp = {
  ...
  animate: (i) => ({ opacity: 1, y: 0, transition: { duration: 0.38, delay: i * 0.08, ease: [0.4, 0, 0.2, 1] } }),
};
    ...
    <PageTransition>
      <div className="inner-page">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
          ...
          {/* CTA card */}
          <motion.div custom={0} variants={fadeUp} initial="initial" animate="animate" className="inner-card inner-card-light" style={{ gridColumn: "1 / 3" }}>
            <div className="freelance-hero">
              ...
              <button className="freelance-cta-btn" onClick={() => window.open(`mailto:${personal.email}`, "_blank")}>
          ...
          {/* Services */}
          <motion.div custom={1} variants={fadeUp} initial="initial" animate="animate" className="inner-card" style={{ gridColumn: "1 / 3" }}>
            <span className="card-label" style={{ marginBottom: 16 }}>Services</span>
